							...
							<div id="login-column" class="col-md-6">
								<div id="login-box" style="    padding: 20px;background-color: #fff; border:1px solid #17a2b8;">
									<form id="login-form" class="form" action="" method="post">
										...
										<div id="register-link" style="display: inline-block;">
											<a href="forgot_password.php" class="text-primary">Forgot Password?</a>
										</div>
										<div id="register-link" style="display: inline-block;float:right">
											Don't have account? <a href="signup.php" class="text-primary">Sign up here</a>
										</div>
									</form>
								</div>
							</div>
